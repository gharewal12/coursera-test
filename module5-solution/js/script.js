...
(function(global){
	...
	var insertproperty1 = function (string,propname,propvalue) {
	...
	// Builds HTML for the home page based on categories array
 	...
 	function buildAndShowHomeHTML (categories) {
 		...
 		$ajaxutils.sendgetrequest(homehtmlurl, function(homehtml) {
 			...
 			var randomproperty = insertproperty1(homehtml,"randomCategoryShortName",chosenCategoryShortName);
 			console.log(randomproperty);
 			var homeHtmlToinsertIntoMainPage = randomproperty ;
 	...
 	function chooseRandomCategory (categories) {
  	...
  	var parsedcategory = JSON.parse(categories);

  	var randomArrayIndex = Math.floor(Math.random() * parsedcategory.length);
  	
  	console.log(parsedcategory[randomArrayIndex].short_name);

  	// return category object with that randomArrayIndex
  	return parsedcategory[randomArrayIndex].short_name;
}
